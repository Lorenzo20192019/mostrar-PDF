        ...
        <form class="form-horizontal validate-form" action="registra.php" enctype="multipart/form-data" method="post">
            ...
            <div class="container-contact1-form-btn">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-8"><input type="submit" value="Enviar Archivo" name="Enviar Archivo" class="btn bg-white"/></div>
            <td><a href="lista3.php">Lista</a> </td>
                </div>
            </div>
